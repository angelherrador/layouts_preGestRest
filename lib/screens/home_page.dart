...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String,dynamic>> families = [
      ...
      {'id': 8, 'name': 'Bebidas', 'image': 'assets/dishes/bebidas/vino_tinto.jpg'},
      {'id': 9, 'name': 'Entrantes', 'image': 'assets/dishes/ensaladas/ensalada_arroz.jpg'},
      {'id':10, 'name': 'Carnes', 'image': 'assets/dishes/carne/escalope.jpg'},
      {'id':11, 'name': 'Pescado', 'image': 'assets/dishes/pescado/trucha_patata.jpg'},
      {'id':12, 'name': 'Marisco', 'image': 'assets/dishes/marisco/gambas.jpg'},
      {'id':13, 'name': 'Postre', 'image': 'assets/dishes/postres/tarta_queso.jpg'},
